...
<main className=" bg-[#fdfdfd] min-h-screen  px-4">
  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
    {[
      ...
      >
        <h3 className="text-sm font-semibold text-[#ea1b48] mb-2">
          Blog Articles
        </h3>
        <h2 className="text-[1.2rem] font-bold hover:text-[#ea1b48] text-gray-800 mb-4">{article.title}</h2>
